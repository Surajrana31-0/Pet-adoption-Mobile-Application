...
dependencies {
    ...
    // Make sure you also have these core Compose dependencies, often managed by a BOM
    implementation(platform("androidx.compose:compose-bom:2024.04.00")) // Or the latest stable BOM

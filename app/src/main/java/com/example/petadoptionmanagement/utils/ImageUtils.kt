    ...
    fun registerLaunchers(onImageSelected: (Uri?) -> Unit) {
        ...
        permissionLauncher = registryOwner.activityResultRegistry.register(
            ...
            if (isGranted) {
                ...
                // Optionally, show a rationale to the user if permission is denied.
            }
        }
    }
    ...
    fun launchImagePicker() {
        ...
        if (ContextCompat.checkSelfPermission(activity, permission) != PackageManager.PERMISSION_GRANTED) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(activity, permission)) {
                ...
                permissionLauncher.launch(permission) // Or show a dialog explaining why you need the permission
            } else {
